...
class Moovie {
    constructor(options) {
        ...
        */
        var SetupLogic = this.SetupLogic = function SetupLogic() {
            ...
            fullscreen.addEventListener("click", function() { console.log("Hello"); SetFullScreen("toggleFullscreen"); }, true);
    ...
    */
    ...
    toggleFullscreen(){ console.log("Hello"); this.SetFullScreen("toggleFullscreen"); }
